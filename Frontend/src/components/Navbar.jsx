...
const Navbar = ()=>{
  ...
  return(<>
       <Box padding='10px 20px' color='white' bg='#202A44' display={['none','none','none','block']} position='sticky' zIndex='10' top='0'>
  ...
  <ButtonGroup gap='10'>
   ...
   <Link to='/add'>
   <Button border='none' _hover={{bg:'none'}} bg='none'>Sell Car</Button>
   </Link>
   <Link to='/myposts'>
